...
title = Freedom Blocker

# (str) Package name
package.name = freedomblocker
...
services = BlockingService:service.py
...
# (str) Python for android blacklist file (must range from current directory)
#p4a.blacklist_file =
